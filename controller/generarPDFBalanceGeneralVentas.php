...
require_once $_SERVER['DOCUMENT_ROOT'] . '/cafeelbuensabor/libraries/fpdf/fpdf.php';
require_once $_SERVER['DOCUMENT_ROOT'] . '/cafeelbuensabor/models/mySql.php';
...
if (isset($_POST['fechaInicial'], $_POST['fechaFinal']) && !empty($_POST['fechaInicial']) && !empty($_POST['fechaFinal'])) {
    ...
    class PDF extends FPDF
    {
        ...
        function TableRow($data)
        {
            ...
            $this->SetFillColor($alternate ? 245 : 255, $alternate ? 245 : 255, $alternate ? 245 : 255);
            $alternate = !$alternate;
    ...
    if (!empty($ventaGeneral)) {
        ...
        echo "Sin Datos";
        header("refresh:3; url=" . $_SERVER['DOCUMENT_ROOT'] . "/cafeelbuensabor/views/dashboard.php");
    }
}
